...
const Flightdetail = () => {
  ...
  const maxPrice = results?.[0]?.reduce((max, hotel) => {
    return Math.max(max, hotel?.Fare?.PublishedFare || 0);
  }, 0);
  const minPrice = results?.[0]?.reduce((min, hotel) => {
    return Math.min(min, hotel?.Fare?.PublishedFare || Infinity);
  }, Infinity);
  ...
  const filteredData = results[0]?.filter((item) => {
    ...
    const priceInRange =
      item?.Fare?.PublishedFare <= priceRangeValue;
      ...
      <div div className="row">
        ...
        <div className="col-lg-9">
          <div className="flgihtdetailsTabBox">
            <div
              className={`flightdetailsTabs ${filter === 1 ? "flightdetailsTabsActive" : ""
                }`}
              onClick={() => setFilter(1)}
            >
              Cheapest
            ...
            <div
              className={`flightdetailsTabs ${filter === 2 ? "flightdetailsTabsActive" : ""
                }`}
              onClick={() => setFilter(2)}
            >
              Fastest
            ...
            <div
              className={`flightdetailsTabs ${filter === 3 ? "flightdetailsTabsActive" : ""
                }`}
              onClick={() => setFilter(3)}
            >
              Best
