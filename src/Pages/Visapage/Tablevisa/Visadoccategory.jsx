...
function Visadoccategory() {
  ...
  return (
    <div style={{marginTop:"64px"}}>
      <h4 style={{ textAlign: "center", fontSize: "30px" }}>Visa Document Category</h4>
            ...
            {data.map((item) => (
              <TableRow key={item._id}>
                ...
                <TableCell style={{color:"white"}}>
                  {item.documentTypesId ? item.documentTypesId.documentName : ""}
                </TableCell>
                <TableCell style={{color:"white"}}>
                  {item.documentTypesId ? item.documentTypesId.description : ""}
                </TableCell>
