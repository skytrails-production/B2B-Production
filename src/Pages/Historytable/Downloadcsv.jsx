...
//         <tr key={index}>
//           <td style={{color:'black',backgroundColor: 'white'}}>{lead.name}</td>
//           <td style={{color:'black',backgroundColor:'white'}}>{lead.email}</td>
//           <td style={{color:'black',backgroundColor: 'white'}}>{lead.mobile}</td>
          
//           <td style={{color:'black',backgroundColor: 'white'}}>{lead.country}</td>
//           <td style={{color:'black',backgroundColor: 'white'}}>{lead.subCategory}</td>
//         </tr>
//       ))}
//     </tbody>
//   </table>
