...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar position="static" sx={{  boxShadow: "none",border:"2px solid red" }}>
      <Toolbar>
        <IconButton
          size="large"
          edge="start"
        ...
        {/* <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
          <img src={STLOGO} alt="Logo" style={{ width: "150px", height: "50px" }} />
        </Typography> */}

        <Box sx={{ display: { xs: "none", md: "flex" }, alignItems: "center" }}>
          {settings.map((setting) => (
            <Button key={setting} color="inherit" sx={{ ml: 2 }}>
              {setting}
            </Button>
          ))}
        </Box>
        ...
        <Box>
          ...
          <Menu
            ...
            onClose={handleCloseUserMenu}
          >
            <MenuItem onClick={signOutAdmin}>Logout</MenuItem>
          </Menu>
        </Box>
      </Toolbar>
    </AppBar>
