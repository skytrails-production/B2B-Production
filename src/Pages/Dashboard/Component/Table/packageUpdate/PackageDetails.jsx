...
function PackageDetails() {
  ...
  const handleApprove = async () => {
    ...
    confirmAlert({
      ...
      message: 'Are you sure you want to approve this package?',
      buttons: [
        {
          label: 'No',
        ...
        },
        {
          ...
          onClick: async () => {
            try {
              ...
              toast.error('Error approving the package. Please try again.', {
                position: 'top-right',
                autoClose: 3000,
                hideProgressBar: false,
                closeOnClick: true,
  ...
  const columns = [
    ...
    { field: "delete", headerName: "Delete", headerClassName: 'custom-header', flex: 1, renderCell: (params) => <Button style={{ color: "#21325D" }} onClick={() => handleDelete(params.row)}>Delete</Button> },
    { field: "approve", headerName: "Approve", headerClassName: 'custom-header', flex: 1, renderCell: (params) => <Button style={{ color: "#21325D" }} onClick={() => handleApprove(params.row)}>Approve</Button> },
