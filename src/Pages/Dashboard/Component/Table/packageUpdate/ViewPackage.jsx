                ...
                <div className="row">
                    ...
                    <div className="col-lg-12 mb-4">
                        <div className="packageName">
                            <p className="mb-3">{viewData?.pakage_title}</p>
                            <span>{`${viewData?.days - 1}N`} / {`${viewData?.days}D`}</span>
                        </div>
                    </div>
                    <div className="col-lg-12 mb-4 packageImgBox" >
                        <div className="PackageImg">
                            <img src={viewData?.pakage_img} alt="" />
                        </div>
                        <div className="packageLocation">
                            <FmdGoodIcon />
                        </div>
                        <div>
                            <p>{viewData?.destination?.map(item => item.addMore).join(', ')}</p>
                        ...
                        <div className="TripHighlight">
                            ...
                            <div className="col-lg-10">
                                <div className="icon-boxHighlight">
                                    ...
                                    {viewData?.insclusions?.map((ele, index) => {
                                        if (
                                            ele?.flexibility ||
                                            ele?.train ||
                                            ele?.bus ||
                        ...
                        <div className="tripOverview">
                            <div className="col-lg-10">
                                <div className="overviewBox">
                                    ...
                                    <p dangerouslySetInnerHTML={{ __html: viewData?.overview }}></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-lg-12 mb-4">
                        <TabContext value={value} style={{}}>
                            ...
                            <TabPanel value="1">
                                <div className="col-lg-12">
                                    {viewData?.detailed_ltinerary?.map((item, index) => {
                                        return (
                                            <>
                                                <Box>
                                                    <Box py={1}> </Box>
                            ...
                            <TabPanel value="2">
                                <div className="col-lg-12">
                                    <div className="hotelDetailsTab">
                                        ...
                                        <p dangerouslySetInnerHTML={{ __html: viewData?.hotel_details }}></p>
                                    </div>
                                </div>
                            </TabPanel>
                            <TabPanel value="3">
                                    ...
                                    <div className="inclusionTab">
                                        <div className="row g-3">
                                            <div className="col-lg-6">
                                                <h2>Inclusion</h2>
                                                <p dangerouslySetInnerHTML={{ __html: viewData?.insclusion_note }}></p>
                                            </div>
                                            <div className="col-lg-6">
                                                <h2>Exclusion</h2>
                                                <p dangerouslySetInnerHTML={{ __html: viewData?.exclusion_note }}></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="tandC">
                                        <div className="row">
                                            <div className="col-lg-12">
                                                ...
                                                <p dangerouslySetInnerHTML={{ __html: viewData?.term_Conditions }}></p>
                                            </div>
                                    ...
                                    <div className="cancelTab">
                                        <div className="row">
                                            <div className="col-lg-12">
                                                ...
                                                <p dangerouslySetInnerHTML={{ __html: viewData?.cancellation_Policy }}></p>
                                            </div>
