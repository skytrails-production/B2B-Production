...
const SightseeingConfirmationDetail = () => {
  return (
    <div>
      ...
      <Box sx={{ padding: '15px', borderRadius: '10px', boxShadow: '0px 3px 6px #00000029', marginTop: '15px' }}>
                ...
                <form action='/'>
                  <Box textAlign='center'>
                    <Button variant="contained" type='submit' style={{ backgroundColor: '#006FFF', borderRadius: '10px' }}>Print</Button>
...
export default SightseeingConfirmationDetail
