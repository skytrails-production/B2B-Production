...
import SightseeingBookingDetail from './SightseeingBookingDetail';
import { Button, Box, Grid, Typography,Link } from '@mui/material';

const SightseeingReviewBooking = () => {
  return (
...
export default SightseeingReviewBooking
