...
import SightseeingGuestDetail from './SightseeingGuestDetail';

const SightseeingGuestsalesummary = () => {
  return (
...
export default SightseeingGuestsalesummary;
