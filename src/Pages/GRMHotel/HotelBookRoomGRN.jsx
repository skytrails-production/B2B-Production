  ...
  const renderRooms = (rooms) =>
    rooms.slice(0, roomsToShow).map((item, index) => (
      <div
        ...
        className="p-3 mb-3 bg-white border rounded-md shadow-sm cursor-pointer"
      >
        <div className="flex flex-row items-center justify-between pb-2">
          ...
          <div className="flex-grow px-3 border-r">
            {item?.rooms?.slice(0, 1)?.map((room, e) => (
              <div key={e}>
                <p className="w-11/12 truncate">{room?.description}</p>
                <p className="">{room?.room_type}</p>
              </div>
            ))}
          </div>
          <div className="flex flex-col items-end px-3">
            <p className="font-semibold text-md text-purple">₹ {item?.price}</p>
            <p className="text-sm font-semibold text-gray-800">Select Room</p>
          </div>
        </div>

        <div className="flex flex-row items-center justify-start gap-2 px-3 pt-2 border-t">
          ...
          {item?.boarding_details?.[0] === "Bed and Breakfast" && (
            <div className="flex flex-row items-center gap-2 font-semibold text-[14px] text-gray-700">
              <Utensils className="w-6 h-6 text-purple" />
              Free Breakfast
            </div>
          )}
          ...
          <div className="container">
            ...
            <div className="mt-2 row gy-4">
              <div className="col-lg-8">
                ...
                <div className="flex flex-col flex-wrap justify-start gap-3 py-3 mt-4 border-gray-300 border-y">
                ...
                <div
                  id="roomSelectionBox"
                  className="flex justify-start pb-4 space-x-4 overflow-auto rounded-md sm:overflow-hidden sm:overflow-x-scroll"
                >
                  {filterOptions.map((type) => (
                    ...
                    >
                      {type}
                      {filterType === type ? (
                        <div className="absolute top-0 right-0 px-2 text-xs font-thin text-white bg-primary-6000 rounded-es-md">
                ...
                <div
                  className="flex justify-start p-2 mb-4 space-x-4 overflow-hidden overflow-x-scroll bg-gray-200 rounded-md"
                ...
                {roomsToShow <
                  ...
                  <button
                    className="py-2 mt-2 mb-2 font-semibold text-gray-800 bg-transparent rounded-md"
                ...
                <div className="sticky overflow-y-scroll border rounded-md shadow-sm top-24 p-7">
                  ...
                  <div className="flex flex-row gap-2 mt-2 ">
                    {showSelectRoomButton && (
                      <button
                        className="flex-grow py-2 text-sm text-white rounded-md bg-primary-6000 "
                        type="primary"
                        onClick={() => {
                          const element =
