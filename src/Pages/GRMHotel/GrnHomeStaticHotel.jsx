            ...
            <div class="grid md:grid-cols-12 gap-8 lg:mb-11 mb-7">
              ...
              >
                <img
                  ...
                  alt="Gallery image"
                  className="object-cover w-full h-full mx-auto transition-transform duration-700 ease-in-out gallery-image rounded-3xl lg:col-span-4 md:col-span-6 hover:scale-105"
                />
