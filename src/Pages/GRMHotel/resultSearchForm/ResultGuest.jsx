        ...
        <>
            ...
            >
              ...
              <div className="flex-grow">
                <span
                  ...
                  className="block w-full p-0 text-xl font-bold text-gray-100 truncate bg-transparent border-none focus:ring-0 focus:outline-none md:text-xl lg:text-xl xl:text-xl placeholder-neutral-800"
                >
                  {totalGuests || ""} Guests
                </span>
            ...
            {hasButtonSubmit && (
              <div className="pr-2 xl:pr-4">
                <a
                  onClick={onSubmit}
                  type="button"
                  className="flex items-center justify-center w-10 h-10 rounded-full shadow-md md:h-12 md:w-12 bg-primary-6000 hover:bg-primary-700 text-neutral-50 focus:outline-none"
                >
                  {loader ? (
                    <svg
                      className="w-6 h-6"
          ...
          >
            <Popover.Panel className="absolute right-0 z-10 w-full sm:min-w-[340px] max-w-sm bg-white top-full mt-3 py-5 sm:py-6 px-4 sm:px-8 rounded-3xl shadow-xl">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  {childAges.map((age, index) => (
                    <div key={index}>
                      ...
                      <input
                        type="number"
                        className="block w-full p-2 mt-1 border border-gray-200 rounded-md shadow-sm sm:text-sm"
                        value={age}
                        onChange={(e) =>
              ...
              <button
                type="button"
                className="w-full px-4 py-2 mt-4 text-sm font-medium text-white border border-transparent rounded-md shadow-sm bg-primary-6000 hover:bg-primary-700"
                onClick={close}
              >
                Done
              </button>
