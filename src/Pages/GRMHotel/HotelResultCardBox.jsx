...
const HotelResultCardBox = ({ result }) => {
  ...
  return (
    ...
    >
      ...
      {result?.featureHotel && (
        <div className="absolute top-0 right-0 flex gap-2 mb-2 flex-start">
      ...
      <div className="mt-2 mb-1 ">
        <h2 className="pb-2 mb-0 text-base font-semibold text-gray-800 truncate border-b">
          {hotelTitle}
        </h2>
      </div>
      ...
      <div className="flex flex-col-reverse items-end justify-between flex-grow w-full gap-2 p-2 bg-purple-100 border border-gray-300 rounded-md ">
        ...
        <div className="flex flex-col items-end w-full">
          <div className="flex flex-col items-end mb-2">
            <div>
              ...
              <span className="mr-2 text-lg text-gray-500 line-through decoration-gray-500 ms-2">
