...
import flightPaymentLoding from "../../Images/loading1/loading-ban.gif";
          ...
          <div className="mt-4 row">
            <div className="col-lg-8">
              <div className="row">
                ...
                <div className="mt-3 mb-2 col-lg-12">
                ...
                <Accordion collapseAll className="border-0 divide-none ">
                  <Accordion.Panel className="mb-2">
                    <Accordion.Title className="flex items-center justify-between w-full gap-3 p-3 mb-2 font-medium text-gray-800 border border-gray-200 rounded-lg focus:ring-0 rtl:text-right hover:bg-gray-100">
                      <div className="flex flex-row items-center gap-2">
