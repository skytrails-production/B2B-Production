...
//     try {
//       const response = await fetch(
//         `${apiURL.baseURL}/skyTrails/api/subAdmin/forgotPassword`,
//         {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
...
//         setForgotPassword(false); // Switch back to the create form
//       } else {
...
//       {forgotPassword ? (
//         <form className="form-agent" onSubmit={handleForgotPasswordSubmit}>
//           <div className="form-group-agent">
//             <label htmlFor="forgot-email" className="form-label-subAdmin">
