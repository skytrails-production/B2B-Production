...
import { validatePincode, validatePassword, validatePAN, validateEmail, validateName, validatePhoneNumber } from "../../utils/validation"
const Login = () => {
  ...
  function personalDetailValidations() {
    if (!validateName(personalDetail.first_name) || personalDetail.last_name === "" || !validateEmail(personalDetail.email) || !validatePhoneNumber(personalDetail.mobile.mobile_number) || personalDetail.address_details.residential_address === "" ||
      ...
      !validatePAN(agencyDetails.pan_number) || !pan || agencyDetails.agency_name === "") {
                              ...
                              >
                                ...
                                <div className="Regestration_inputFilds_Container">
                                  ...
                                  >
                                    <div className="form_input_regestration"   >
                                      ...
                                      />
                                      {sub && !validateName(personalDetail.first_name) && <span id="error1">Enter  a valid first name</span>}
                                    </div>
                                    <div className="form_input_regestration" mx={2}>
                                      ...
                                      />
                                      {sub && !validateName(personalDetail.last_name) && <span id="error1">Enter valid last name</span>}
                                    </div>
                                ...
                                <div className="Regestration_inputFilds_Container">
                                  ...
                                  >
                                    <div className="form_input_regestration">
                                      ...
                                      />
                                      {sub && personalDetail.address_details.residential_address === "" && <span id="error1">Enter residential_address</span>}
                                    </div>
                                    <div className="form_input_regestration">
                                      <label className="form_lable_regestration">
                                        {" "}
                                      ...
                                      />
                                      {/* {sub && personalDetail.address_details.address_2 === "" && <span id="error1">Enter Address 2</span>} */}
                                    </div>
                                ...
                                <div className="Regestration_inputFilds_Container">
                                  ...
                                  >
                                    ...
                                    <div className="form_input_regestration">
                                      <label className="form_lable_regestration">City</label>
                                      <input
                                        type="text"
                                        name="city"
                                      ...
                                      />
                                      {sub && personalDetail.address_details.city === "" && <span id="error1">Enter Your City</span>}
                                    </div>
                                    ...
                                    <div className="form_input_regestration" mx={2}>
                                      ...
                                      />
                                      {sub && personalDetail.address_details.state === "" && <span id="error1">Enter State</span>}
                                    </div>
                                ...
                                <div className="Regestration_inputFilds_Container">
                                  ...
                                  >
                                    <div className="form_input_regestration">
                                      ...
                                      />
                                      {sub && !validatePincode(personalDetail.address_details.pincode) && <span id="error1">Enter Pin Code</span>}
                                    </div>

                                    <div className="form_input_regestration">
                                      <label className="form_lable_regestration">Country</label>
                                      <input
                                        type="text"
                                        name="country"
                                      ...
                                      />
                                      {sub && personalDetail.address_details.country === "" && <span id="error1">Enter Countery</span>}
                                    </div>
                                ...
                                <div className="Regestration_inputFilds_Container">
                                  ...
                                  >
                                    ...
                                    <div className="form_input_regestration" mx={2}>
                                      ...
                                      />
                                      {sub && !validatePhoneNumber(personalDetail.mobile.mobile_number) && <span id="error1">Enter Mobile Number</span>}
                                    </div>
                                    <div className="form_input_regestration">
                                      <label className="form_lable_regestration">
                                        Agency Name
                                      ...
                                      />
                                      {sub && agencyDetails.agency_name === "" && <span id="error1">Enter Agency Name</span>}
                                ...
                                <div className="Regestration_inputFilds_Container">
                                  ...
                                  >
                                    <div className="form_input_regestration">
                                      <label className="form_lable_regestration">PAN</label>
                                      <input
                                      ...
                                      />
                                      {sub && !pan && <span id="error1">Enter Mobile Number</span>}
                                    </div>
                                    <div className="form_input_regestration">
                                      <label className="form_lable_regestration">
                                        PAN Number
                                      ...
                                      />
                                      {sub && !validatePAN(agencyDetails.pan_number) && <span id="error1">Enter a valid pan number</span>}
                                    </div>
                                  </div>
                                </div>
                                <div className="Regestration_inputFilds_Container">
                                  ...
                                  >
                                    ...
                                    <div className="form_input_regestration">
                                      <label className="form_lable_regestration">Email</label>
                                      <input
                                        type="email"
                                        name="email"
                                      ...
                                      />
                                      {sub && !validateEmail(personalDetail.email) && <span id="error1">Enter Your Email </span>}
                                    </div>
                                    <div className="form_input_regestration">
                                      <label className="form_lable_regestration">
                                        Password*
                                      ...
                                      />
                                      {sub && !validatePassword(personalDetail.password) && <span id="error1">Level up! 8+ char, mix cases, 1+ number. </span>}
                                    </div>
