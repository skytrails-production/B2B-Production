...
import HolidayconfirmationDetail from './HolidayconfirmationDetail';

import HolidayConfirmationSummary from './HolidayConfirmationSummary';
...
const Holidaybookingconfirmation = () => {
  return (
    <div>
        ...
        <div>
          <Grid container spacing={3}>
            <Grid sm={12} xs={12} md={9} item>
              <Box>
                <HolidayconfirmationDetail/>
              </Box>
            </Grid>
            <Grid sm={12} xs={12} md={3} item>
              
              <Box>
              <HolidayConfirmationSummary />
              </Box>
...
export default Holidaybookingconfirmation
