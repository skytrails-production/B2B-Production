...
function UploadSocailId({ UserId }) {
        ...
        <div className='contolsMainDiv'>
            ...
            >
                ...
                >
                    ...
                    <div style={{ marginTop: '20px', fontWeight: 'bold', color: 'var(--main-bg-color-secondery)', borderRadius: '8px', fontSize: '30px' }}>Upload Social Account</div>

                    <input type="hidden" name="userId" value={UserId} />
                    <input type="text" name="instaId" placeholder="Enter Insta Id" onChange={(e) => setInstaId(e.target.value)}

                    />
                    <input type="text" name="facebookId" placeholder="Enter Facebook Id" onChange={(e) => setFacebookId(e.target.value)} />
                    <input type="text" name="googleId" placeholder="Enter Google Id" onChange={(e) => setGoogleId(e.target.value)} />
                    <input type="text" name="linkedinId" placeholder="Enter Linkedin Id" onChange={(e) => setLinkedinId(e.target.value)} />
                    <input type="file" accept="jpeg,jpg,png" style={{marginTop:"3px"}} onChange={(e) => setImages(e.target.files[0])} />
