...
const HotelTicket = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${apiURL.baseURL}/skyTrails/agent/getgrnbookingbyid?id=${id}`
        );
        if (response?.data) {
          setData(response?.data);
        ...
        <>
          ...
          >
            ...
            <div id="pdf-content" ref={targetRef}>
              ...
              >
                <div className="containerGrnTicket">
                  <div className="booking-passGrn sectionGrnTicket">
                    <h2 className="roomh2">Booking Information</h2>
                    <div className="bookBoxGrn">
                      <div className="bookOne">
                        ...
                        <p>
                          <strong>Total Price:</strong>₹ {data?.data?.total}
                        </p>
                      </div>
                  ...
                  <div>
                    <h2 className="roomh2" style={{ marginBottom: "35px" }}>
                      Hotel Information
                    </h2>
                    <div className="imgBox">
                      <div className="hotel-imageGrn">
                        <img src={data.data.hotel.imageUrl} alt="Hotel Image" />
                      </div>
                      <div className="hotel-DetailsGrn">
                        <h6>
                        ...
                        <h6>
                          ...
                          {data?.data?.hotel?.category}
                        </h6>
                      </div>
                    </div>
                  </div>
                  <div className="sectionGrnTicket holder-info">
                    <h2 className="roomh2" style={{ marginBottom: "40px" }}>
                      Holder Information
                    </h2>
                    <p>
                      <strong>Name:</strong>
                    ...
                    <p>
                      ...
                      {data.data.holder.client_nationality}
                    </p>
                    <p>
                      <strong>Email:</strong>
                      {data.data.holder.email}
                    </p>
                    <p>
                      <strong>PAN Number:</strong>
                      {data.data.holder.pan_number}
                    </p>
                  </div>
                  <div className="sectionGrnTicket pax-infogrn">
                    <h2 className="roomh2" style={{ marginTop: "45px" }}>
                      Passengers
                    </h2>
                    <div>
                      <table id="customersGrn">
                        <thead>
                          <tr>
                            <th>Name</th>
                            <th>Age</th>
                        ...
                        <tbody>
                          {data.data.hotel?.paxes?.map((item, index) => (
                            <tr key={index}>
                              <td>
                  ...
                  <div className="sectionGrnTicket room-info">
                    <h2 className="roomh2">Room Details</h2>
                    <p>
                      <strong>Rooms:</strong>
                      {data.data.hotel.rooms.length}
                    </p>
                    <p>
                      <strong>Guest:</strong>
                      {data.data.hotel.paxes.length}
                    </p>
                  </div>
                  <div className="sectionGrnTicket cancellation-policy">
                    <h2 className="roomh2">Cancellation Policy</h2>
                    <p>
                      {data.data.hotel.non_refundable ? (
                        <h4 style={{ color: "red" }}>No cancellation</h4>
                      ) : (
                        <>
                          <span>Refundable: Yes</span>
                          <br />
                          <span>
                            Cancel by Date:{" "}
                            {data.data.hotel.cancellation_policy.cancel_by_date}
                          </span>
                        </>
                      )}
                    </p>
              ...
              <div className="support-sectionGrn">
                <div className="support-titleGrn">The Skytrails Support</div>
                <div className="support-contactGrn">
                  <div className="contact-boxGrn">
                    <div>+91 9209793097</div>
                  </div>
                  <div className="contact-emailGrn">
