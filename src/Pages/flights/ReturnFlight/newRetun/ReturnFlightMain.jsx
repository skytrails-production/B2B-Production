...
const ReturnFlightMain = () => {
  ...
  return (
    <div>
      ...
      <div className="sticky top-0 left-0 z-40 hidden w-full md:flex z-3 bg-gradient-to-b from-primary-6000 via-primary-6000 to-primary-6000">
        {/* <Oneway2 /> */}
        <div className="flex items-center justify-center p-2 custom-container">
      ...
      <div className="mt-3 custom-container"  style={{marginLeft:"auto",marginRight:"auto",paddingLeft:"1rem",paddingRight:"1rem"}}>
        {/* {reducerState?.oneWay?.isError && !loaderFilter && <NoFlightResult />} */}
        {
          ...
          true && (
            <div className="row">
              <div
                className="p-0 col-lg-3 visibleBig"
              ...
              <div
                className="col-lg-12 visibleSmall stikcyHotelFilter"
