                            ...
                            return (
                              <div>
                                ...
                                >
                                  <div
                                    key={index}
                                    className="container mb-4 flightdestination"
                                    style={{ paddingTop: "13px" }}
                                  >
                                    <div className="row w-100 flight-detailss">
                                      <div className="mb-3 col-6 col-md-5 align-items-center mb-md-0 flightdestination-right">
                                      ...
                                      <div
                                        className="mb-3 col-12 col-md-2 mb-md-0"
                                        style={{
                                          display: "flex",
    ...
    {layoverDuration !== 0 && (
            ...
            <div className="flightLayover">
              ...
              Layover Time: {layoverHours !== 0 && `${layoverHours}h`} {layoverMinutes !== 0 && `${layoverMinutes} m`}
                    ...
                    {/* <motion.div variants={variants} className="mt-3 col-lg-12">
                      <div className="bookBottomFour">
                                    <div>
                                      <p>Baggage</p>
                                      <span>ADULT</span>
                    ...
                    {/* <div className="mt-4 col-lg-12 accor_dian">
                      {fareRule && (
                        <div my={2}>
                    ...
                    {!isDropdown && (
                      <div className="my-4 col-lg-12 smallButtMobile">
                        {V_aliation ? (
                          <button
                    ...
                    <div className="mt-3 d-block d-sm-none col-lg-3 col-md-3">
                      <BookNowLeft
                        // toggle={toggle}
                    ...
                    {isDropdown && (
                      <div className="my-4 col-lg-12 smallButtMobile d-flex justify-content-between align-items-center">
                        {V_aliation ? (
                          <button
                            className="bookWrapperButton"
                            type="submit"
