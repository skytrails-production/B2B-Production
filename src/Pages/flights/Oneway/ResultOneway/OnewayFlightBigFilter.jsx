...
const OnewayFlightBigFilter = ({
              ...
              let itemShow = isItem ? (
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className=" flex  items-center   gap-1 justify-between p-0 !font-medium">
                    <div className="flex">
                      <p className="text-sm text-green-400 text-nowrap">₹ </p>
  ...
  const AirlineFilter = () => {
    ...
    return (
      <div className="flight-filter-aireline">
        ...
        <div className="gap-2 flight-filter-aireline-item">
          {Airlines &&
  ...
  return (
    <div className="flightFilterMainBox">
      ...
      <div className="mt-3 holidayFilterSlider flight-filter-aireline">
        <p>Filter By Price</p>
        <Slider
          range
          step={400}
