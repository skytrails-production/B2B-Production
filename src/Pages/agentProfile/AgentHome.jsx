...
const AgentHome = ({ data }) => {
    ...
    useEffect(() => {
        function getTotalRevenue(agentInviteData) {
            ...
            if (!Array.isArray(agentInviteData)) {
                throw new Error('Invalid data format: agentInviteData must be an array');
            }
            ...
            const totalRevenue = agentInviteData.reduce((sum, agent) => {
                ...
                if (!agent.hasOwnProperty('totalRevenue')) {
                    throw new Error('Missing property: agent object must have a "totalRevenue" property');
                }
        ...
        if (data?.agentInviteData) {
            ...
            setTotalRevenue(getTotalRevenue(data?.
                agentInviteData))
        }
    }, [data])
    ...
    return (
        <div >
            ...
            <div>
                {data?.agentInviteData?.length > 0 ? <div className='agentHomeDataContainer'>
                    <div className='agentHomeDataItem'>
                        ...
                        <div style={{ display: "flex", height: "100%", justifyContent: "center", alignItems: "center" }}><MdSupportAgent size={30} /> </div>
                    </div>
                    <div className='agentHomeDataItem'>
                        <div className='agentHomeDataItemleft'>
                        ...
                        <div style={{ display: "flex", height: "100%", justifyContent: "center", alignItems: "center" }}><LiaMoneyBillWaveSolid size={30} /> </div>
                    </div>

                </div> : <div className='agentNotAccess' >
                    <div style={{
                        width: '500px',
                        // backgroundColor: 'red',
                        height: "100px"
