...
//     // agentId,instaId,facebookId,googleId,linkedinId
...
//         try{
//             e.preventDefault();
//             const response=await axios.post(`${apiURL.baseURL}/skyTrails/agent/updatePersonalProfile`,
//             payload,
...
//                     <input type="text" name="instaId" placeholder="Enter instaId" onChange={(e)=>setInstaId(e.target.value)} style={{width:'50%'}}/>
//                     <input type="text" name="facebookId" placeholder="Enter facebookId" onChange={(e)=>setFacebookId(e.target.value)} style={{width:'50%'}}/>
//                     <input type="text" name="googleId" placeholder="Enter googleId" onChange={(e)=>setGoogleId(e.target.value)} style={{width:'50%'}}/>
//                     <input type="text" name="linkedinId" placeholder="Enter linkedinId" onChange={(e)=>setLinkedinId(e.target.value)} style={{width:'50%'}}/>
//                     <input type="file" accept="jpeg,jpg,png" onChange={(e)=>setImages(e.target.files[0])}/>
//                     <button type="submit"
//                             style={{
//                                 width: '100%',
//                                 padding: '6.5px',
