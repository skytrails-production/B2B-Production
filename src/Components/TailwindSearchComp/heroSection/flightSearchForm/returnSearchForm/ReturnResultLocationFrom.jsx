    ...
    return (
      <>
        {uniqueRecentSearches.length > 0 && (
          <h3 className="block px-4 mt-2 text-base font-semibold sm:mt-0 sm:px-8 sm:text-lg text-neutral-800" style={{textAlign:"left"}}>
            Recent searches
          </h3>
        )}
        <div className="mt-2">
    ...
    <div className={`relative flex ${className}`} ref={containerRef}>
      ...
      >
        <div className="text-neutral-300">
          <PlaneTakeoff className="w-5 h-5 text-[#D1D5DB] lg:w-7 lg:h-7" />
        </div>
        <div className="flex-grow">
          <input
            className="block w-full p-0 text-xl font-bold text-gray-100 truncate bg-transparent border-none placeholder:text-gray-100 focus:ring-0 focus:outline-none md:text-xl lg:text-xl xl:text-xl placeholder-neutral-800"
