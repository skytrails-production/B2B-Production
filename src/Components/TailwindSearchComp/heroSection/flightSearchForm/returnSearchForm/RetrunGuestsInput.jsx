    ...
    <Popover className={`flex relative ${className}`}>
      {({ open, close }) => (
        <>
          ...
          >
            <Popover.Button
              className={`relative z-10 flex-1 flex text-left items-center ${fieldClassName} space-x-3 focus:outline-none mr-5`}
            >
              <div className="text-neutral-300">
                <UserPlusIcon className="w-5 h-5 lg:w-7 lg:h-7 text-[#D1D5DB]" />
              </div>
              <div className="flex-grow">
                <span className="block w-full p-0 text-xl font-bold text-gray-100 truncate bg-transparent border-none focus:ring-0 focus:outline-none md:text-xl lg:text-xl xl:text-xl placeholder-neutral-800">
            ...
            {hasButtonSubmit && (
              <div className="pr-2 xl:pr-4">
                <a
                  onClick={onSubmit}
                  type="button"
                  className="flex items-center justify-center w-10 h-10 text-white rounded-full shadow-md md:h-12 md:w-12 bg-primary-6000 hover:bg-primary-700 text-neutral-50 focus:outline-none"
                >
          ...
          >
            <Popover.Panel className="absolute right-0 z-10 w-full sm:min-w-[340px] max-w-sm bg-white top-full mt-3 py-5 sm:py-6 px-4 sm:px-8 rounded-3xl shadow-xl">
              {/* <div className="absolute inset-0 z-0 bg-black pointer-events-none opacity-20"></div>{" "} */}
              ...
              >
                ...
                {["adult", "child", "infant"].map((type) => {
                  ...
                  return (
                    <div key={type} className="flex flex-col rounded-lg ">
                      <span className="mb-2 font-medium text-gray-700 capitalize">
                ...
                <h2 className="mb-4 text-sm font-semibold ">Class</h2>
                ...
                <div className="flex items-center justify-end w-full mt-6">
                  ...
                  <button
                    className="px-4 py-2 font-bold text-center text-white bg-indigo-700 rounded-full cursor-pointer text-md"
                    onClick={(e) => {
                      e.preventDefault();
                      close();
