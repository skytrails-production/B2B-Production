...
const FlightSearchForm = () => {
          ...
          <>
            ...
            >
              <Popover.Panel className="absolute z-20 w-screen max-w-[350px] sm:max-w-[220px] xl:px-4 lg:px-4 md:px-4 top-full mt-3 transform -translate-x-1/2 left-1/2 sm:px-0">
                <div className="overflow-hidden shadow-lg rounded-2xl ring-1 ring-black/5">
                  <div className="relative grid gap-8 bg-white p-7">
                    {flightClass.map((item) => (
                      <a
                        ...
                        className="flex items-center p-2 -m-3 text-gray-900 no-underline transition duration-150 ease-in-out rounded-lg hover:bg-gray-50 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                      >
  ...
  const renderRadioBtn = () => {
    return (
      <div className="flex flex-row flex-wrap justify-center px-6 py-3 mb-2 border-b-2 border-gray-200 md:py-4 md:px-7 xl:py-6 xl:px-8 md:justify-start md:border-b-2 md:border-gray-300">
        <div
        ...
        <div className="self-center hidden h-8 my-1 mr-2 border-r-2 border-slate-300 md:flex sm:mr-3"></div>
        <div className="my-1 mr-2 border-2 rounded-full sm:mr-3 border-slate-300">
          {renderSelectClass()}
        </div>
        <div className="my-1 border-2 rounded-full border-slate-300">
          {renderGuest()}
        </div>
      </div>
    );
