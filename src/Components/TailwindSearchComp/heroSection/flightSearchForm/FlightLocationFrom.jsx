    ...
    >
      ...
      >
        <div className="text-neutral-300">
          <PlaneTakeoff className="w-5 h-5 lg:w-7 lg:h-7 text-[#D9DCE1]" />
        </div>
        <div className="flex-grow">
          <input
            className="block w-full p-0 text-base font-bold truncate bg-transparent border-none focus:ring-0 focus:outline-none focus:placeholder-neutral-300 md:text-2xl placeholder-neutral-800"
