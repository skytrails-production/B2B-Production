    ...
    return (
      <>
        <div className="text-neutral-300">
          <CalendarIcon className="w-5 h-5 lg:w-7 lg:h-7 text-[#D9DCE1]" />
        </div>
            ...
            {hasButtonSubmit && (
              <div className="pr-2 xl:pr-4">
                <a
                  onClick={onSubmit}
                  type="button"
                  className="flex items-center justify-center text-white rounded-full h-14 md:h-16 w-14 md:w-16 bg-primary-6000 text-neutral-50 focus:outline-none"
                >
