            ...
            <div className="w-full bg-white rounded-xl">
              {/* {faq?.map((item, i) => {
                return (
                  <Disclosure
                    as="div"
                    className="p-6 transition-all duration-500 border-b border-gray-200 border-solid group accordion rounded-2xl hover:bg-indigo-50 accordion-active:bg-indigo-50 active"
                    defaultOpen={false}
                  >
                    <DisclosureButton className="inline-flex items-center justify-between w-full leading-8 text-left text-gray-900 transition duration-500 group accordion-toggle hover:text-indigo-600 accordion-active:font-medium accordion-active:text-indigo-600 ">
                    ...
                    <DisclosurePanel className="mt-2 leading-6 text-gray-900 text-sm/5 text-start">
                      {item.A}
                    </DisclosurePanel>
                  </Disclosure>
                );
